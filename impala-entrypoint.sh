...
KUDU_MASTERS=${KUDU_MASTERS:="kudu-master-1:7051,kudu-master-2:7051,kudu-master-3:7051"}
...
function start_impalad() {
  ...
  -kudu_master_hosts=${KUDU_MASTERS} --enable_ldap_auth --ldap_passwords_in_clear_ok --ldap_uri ldap://ldap:389 &
}
